...
GitHub renders SVGs embedded via <img> and runs their SMIL animations (JS
...
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(HERE, "..", "venkat-ascii.svg")
...
# tuning for a dark-background portrait (already grayscale B&W)
CONTRAST = 1.15
BRIGHTNESS = 1.1
GAMMA = 1.10
SHARPEN = True
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">venkat@github: ~$ ./portrait.sh</text>')
